...
```
Her skal vi nok lige undersøge hvorfor de ikke starter det samme sted hehe
...
Caculating BIC for the Compound poisson regression has to be done manually for some reason
```{r}
...
## Conclusion
TROR konklusionen blir almindelig nbin
